      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10 text-sm text-gray-700">
        ...
        <div className="text-left">
          ...
          <ul className="space-y-2">
            <li><Link to="/aboutus" className="text-red-500 hover:underline">• About Us</Link></li>
            <li><Link to="/services" className="text-gray-700 dark:text-white hover:underline">Services</Link></li>
            <li><Link to="/cars" className="hover:underline">Cars</Link></li>
            <li><Link to="/partners" className="hover:underline">Our Partner</Link></li>
          </ul>
        </div>
        ...
        <div className="text-left">
          ...
          <ul className="space-y-2">
            <li><Link to="/services/instant-rent" className="text-gray-700 dark:text-white hover:underline">Instant Rent</Link></li>
            <li><Link to="/services/private-driver" className="text-gray-700 dark:text-white hover:underline">Private Driver</Link></li>    
             <li>  <Link to="/services/long-trip" className="text-gray-700 dark:text-white hover:underline">Long Trip</Link></li> 
          </ul>
        </div>
